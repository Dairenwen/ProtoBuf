...
PROTOBUF_NAMESPACE_OPEN
template<> ::s_contact::Address* Arena::CreateMaybeMessage<::s_contact::Address>(Arena*);
template<> ::s_contact::Contacts* Arena::CreateMaybeMessage<::s_contact::Contacts>(Arena*);
template<> ::s_contact::PeopleInfo* Arena::CreateMaybeMessage<::s_contact::PeopleInfo>(Arena*);
template<> ::s_contact::PeopleInfo_RemarkEntry_DoNotUse* Arena::CreateMaybeMessage<::s_contact::PeopleInfo_RemarkEntry_DoNotUse>(Arena*);
template<> ::s_contact::PeopleInfo_phone* Arena::CreateMaybeMessage<::s_contact::PeopleInfo_phone>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace s_contact {
...
class Address final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:s_contact.Address) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:s_contact.Address)
 private:
  class _Internal;
...
class PeopleInfo_phone final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:s_contact.PeopleInfo.phone) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "s_contact.PeopleInfo.phone";
  }
  protected:
  ...
  // .s_contact.PeopleInfo.phone.Type type = 2;
  void clear_type();
  ::s_contact::PeopleInfo_phone_Type type() const;
  void set_type(::s_contact::PeopleInfo_phone_Type value);
  private:
  ::s_contact::PeopleInfo_phone_Type _internal_type() const;
  void _internal_set_type(::s_contact::PeopleInfo_phone_Type value);
  public:

  // @@protoc_insertion_point(class_scope:s_contact.PeopleInfo.phone)
 private:
  class _Internal;
...
public:
  ...
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "s_contact.PeopleInfo.RemarkEntry.key");
 }
  static bool ValidateValue(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "s_contact.PeopleInfo.RemarkEntry.value");
 }
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadata() const final;
  friend struct ::TableStruct_contact_2eproto;
...
class PeopleInfo final :
 ...
 public:
  ...
  // .s_contact.PeopleInfo.phone phone_number = 8;
  bool has_phone_number() const;
  private:
  bool _internal_has_phone_number() const;
  public:
  void clear_phone_number();
  const ::s_contact::PeopleInfo_phone& phone_number() const;
  PROTOBUF_NODISCARD ::s_contact::PeopleInfo_phone* release_phone_number();
  ::s_contact::PeopleInfo_phone* mutable_phone_number();
  void set_allocated_phone_number(::s_contact::PeopleInfo_phone* phone_number);
  private:
  const ::s_contact::PeopleInfo_phone& _internal_phone_number() const;
  ::s_contact::PeopleInfo_phone* _internal_mutable_phone_number();
  public:
  void unsafe_arena_set_allocated_phone_number(
      ::s_contact::PeopleInfo_phone* phone_number);
  ::s_contact::PeopleInfo_phone* unsafe_arena_release_phone_number();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::s_contact::PeopleInfo_phone* phone_number_;
...
class Contacts final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:s_contact.Contacts) */ {
 public:
  ...
  // repeated .s_contact.PeopleInfo contacts = 1;
  int contacts_size() const;
  private:
  int _internal_contacts_size() const;
  public:
  void clear_contacts();
  ::s_contact::PeopleInfo* mutable_contacts(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contact::PeopleInfo >*
      mutable_contacts();
  private:
  const ::s_contact::PeopleInfo& _internal_contacts(int index) const;
  ::s_contact::PeopleInfo* _internal_add_contacts();
  public:
  const ::s_contact::PeopleInfo& contacts(int index) const;
  ::s_contact::PeopleInfo* add_contacts();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contact::PeopleInfo >&
      contacts() const;

  // @@protoc_insertion_point(class_scope:s_contact.Contacts)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contact::PeopleInfo > contacts_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_contact_2eproto;
...
inline const std::string& Address::home_address() const {
  // @@protoc_insertion_point(field_get:s_contact.Address.home_address)
...
void Address::set_home_address(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.home_address_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:s_contact.Address.home_address)
}
inline std::string* Address::mutable_home_address() {
  std::string* _s = _internal_mutable_home_address();
  // @@protoc_insertion_point(field_mutable:s_contact.Address.home_address)
  return _s;
}
...
inline std::string* Address::release_home_address() {
  // @@protoc_insertion_point(field_release:s_contact.Address.home_address)
...
inline void Address::set_allocated_home_address(std::string* home_address) {
  ...
  // @@protoc_insertion_point(field_set_allocated:s_contact.Address.home_address)
}
...
inline const std::string& Address::unit_address() const {
  // @@protoc_insertion_point(field_get:s_contact.Address.unit_address)
...
void Address::set_unit_address(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.unit_address_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:s_contact.Address.unit_address)
}
inline std::string* Address::mutable_unit_address() {
  std::string* _s = _internal_mutable_unit_address();
  // @@protoc_insertion_point(field_mutable:s_contact.Address.unit_address)
  return _s;
}
...
inline std::string* Address::release_unit_address() {
  // @@protoc_insertion_point(field_release:s_contact.Address.unit_address)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:s_contact.Address.unit_address)
}
...
inline const std::string& PeopleInfo_phone::number() const {
  // @@protoc_insertion_point(field_get:s_contact.PeopleInfo.phone.number)
...
void PeopleInfo_phone::set_number(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.number_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:s_contact.PeopleInfo.phone.number)
}
inline std::string* PeopleInfo_phone::mutable_number() {
  std::string* _s = _internal_mutable_number();
  // @@protoc_insertion_point(field_mutable:s_contact.PeopleInfo.phone.number)
  return _s;
}
...
inline std::string* PeopleInfo_phone::release_number() {
  // @@protoc_insertion_point(field_release:s_contact.PeopleInfo.phone.number)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:s_contact.PeopleInfo.phone.number)
}
...
inline ::s_contact::PeopleInfo_phone_Type PeopleInfo_phone::_internal_type() const {
  return static_cast< ::s_contact::PeopleInfo_phone_Type >(_impl_.type_);
}
inline ::s_contact::PeopleInfo_phone_Type PeopleInfo_phone::type() const {
  // @@protoc_insertion_point(field_get:s_contact.PeopleInfo.phone.type)
  return _internal_type();
}
inline void PeopleInfo_phone::_internal_set_type(::s_contact::PeopleInfo_phone_Type value) {
  
  _impl_.type_ = value;
}
inline void PeopleInfo_phone::set_type(::s_contact::PeopleInfo_phone_Type value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:s_contact.PeopleInfo.phone.type)
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Any& PeopleInfo::any() const {
  // @@protoc_insertion_point(field_get:s_contact.PeopleInfo.any)
...
inline void PeopleInfo::unsafe_arena_set_allocated_any(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:s_contact.PeopleInfo.any)
}
...
inline ::PROTOBUF_NAMESPACE_ID::Any* PeopleInfo::unsafe_arena_release_any() {
  // @@protoc_insertion_point(field_release:s_contact.PeopleInfo.any)
...
inline ::PROTOBUF_NAMESPACE_ID::Any* PeopleInfo::mutable_any() {
  ...
  // @@protoc_insertion_point(field_mutable:s_contact.PeopleInfo.any)
  return _msg;
}
inline void PeopleInfo::set_allocated_any(::PROTOBUF_NAMESPACE_ID::Any* any) {
  ...
  _impl_.any_ = any;
  // @@protoc_insertion_point(field_set_allocated:s_contact.PeopleInfo.any)
}
...
inline const std::string& PeopleInfo::qq() const {
  // @@protoc_insertion_point(field_get:s_contact.PeopleInfo.qq)
  return _internal_qq();
}
template <typename ArgT0, typename... ArgT>
inline void PeopleInfo::set_qq(ArgT0&& arg0, ArgT... args) {
  ...
  // @@protoc_insertion_point(field_set:s_contact.PeopleInfo.qq)
}
inline std::string* PeopleInfo::mutable_qq() {
  std::string* _s = _internal_mutable_qq();
  // @@protoc_insertion_point(field_mutable:s_contact.PeopleInfo.qq)
  return _s;
}
...
inline std::string* PeopleInfo::release_qq() {
  // @@protoc_insertion_point(field_release:s_contact.PeopleInfo.qq)
  if (_internal_has_qq()) {
    clear_has_other_types();
...
inline void PeopleInfo::set_allocated_qq(std::string* qq) {
  ...
  // @@protoc_insertion_point(field_set_allocated:s_contact.PeopleInfo.qq)
}
...
inline const std::string& PeopleInfo::wechat() const {
  // @@protoc_insertion_point(field_get:s_contact.PeopleInfo.wechat)
...
inline void PeopleInfo::set_wechat(ArgT0&& arg0, ArgT... args) {
  ...
  // @@protoc_insertion_point(field_set:s_contact.PeopleInfo.wechat)
}
inline std::string* PeopleInfo::mutable_wechat() {
  std::string* _s = _internal_mutable_wechat();
  // @@protoc_insertion_point(field_mutable:s_contact.PeopleInfo.wechat)
  return _s;
}
...
inline std::string* PeopleInfo::release_wechat() {
  // @@protoc_insertion_point(field_release:s_contact.PeopleInfo.wechat)
  if (_internal_has_wechat()) {
    clear_has_other_types();
...
inline void PeopleInfo::set_allocated_wechat(std::string* wechat) {
  ...
  // @@protoc_insertion_point(field_set_allocated:s_contact.PeopleInfo.wechat)
}
...
PeopleInfo::remark() const {
  // @@protoc_insertion_point(field_map:s_contact.PeopleInfo.remark)
...
PeopleInfo::mutable_remark() {
  // @@protoc_insertion_point(field_mutable_map:s_contact.PeopleInfo.remark)
  return _internal_mutable_remark();
}

// .s_contact.PeopleInfo.phone phone_number = 8;
inline bool PeopleInfo::_internal_has_phone_number() const {
  return this != internal_default_instance() && _impl_.phone_number_ != nullptr;
}
inline bool PeopleInfo::has_phone_number() const {
  return _internal_has_phone_number();
}
inline void PeopleInfo::clear_phone_number() {
  if (GetArenaForAllocation() == nullptr && _impl_.phone_number_ != nullptr) {
    delete _impl_.phone_number_;
  }
  _impl_.phone_number_ = nullptr;
}
inline const ::s_contact::PeopleInfo_phone& PeopleInfo::_internal_phone_number() const {
  const ::s_contact::PeopleInfo_phone* p = _impl_.phone_number_;
  return p != nullptr ? *p : reinterpret_cast<const ::s_contact::PeopleInfo_phone&>(
      ::s_contact::_PeopleInfo_phone_default_instance_);
}
inline const ::s_contact::PeopleInfo_phone& PeopleInfo::phone_number() const {
  // @@protoc_insertion_point(field_get:s_contact.PeopleInfo.phone_number)
  return _internal_phone_number();
}
inline void PeopleInfo::unsafe_arena_set_allocated_phone_number(
    ::s_contact::PeopleInfo_phone* phone_number) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:s_contact.PeopleInfo.phone_number)
}
inline ::s_contact::PeopleInfo_phone* PeopleInfo::release_phone_number() {
  
  ::s_contact::PeopleInfo_phone* temp = _impl_.phone_number_;
  _impl_.phone_number_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::s_contact::PeopleInfo_phone* PeopleInfo::unsafe_arena_release_phone_number() {
  // @@protoc_insertion_point(field_release:s_contact.PeopleInfo.phone_number)
  
  ::s_contact::PeopleInfo_phone* temp = _impl_.phone_number_;
  _impl_.phone_number_ = nullptr;
  return temp;
}
inline ::s_contact::PeopleInfo_phone* PeopleInfo::_internal_mutable_phone_number() {
  
  if (_impl_.phone_number_ == nullptr) {
    auto* p = CreateMaybeMessage<::s_contact::PeopleInfo_phone>(GetArenaForAllocation());
    _impl_.phone_number_ = p;
  }
  return _impl_.phone_number_;
}
inline ::s_contact::PeopleInfo_phone* PeopleInfo::mutable_phone_number() {
  ::s_contact::PeopleInfo_phone* _msg = _internal_mutable_phone_number();
  // @@protoc_insertion_point(field_mutable:s_contact.PeopleInfo.phone_number)
  return _msg;
}
inline void PeopleInfo::set_allocated_phone_number(::s_contact::PeopleInfo_phone* phone_number) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.phone_number_;
  }
  ...
  _impl_.phone_number_ = phone_number;
  // @@protoc_insertion_point(field_set_allocated:s_contact.PeopleInfo.phone_number)
}
...
inline ::s_contact::PeopleInfo* Contacts::mutable_contacts(int index) {
  // @@protoc_insertion_point(field_mutable:s_contact.Contacts.contacts)
  return _impl_.contacts_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contact::PeopleInfo >*
Contacts::mutable_contacts() {
  // @@protoc_insertion_point(field_mutable_list:s_contact.Contacts.contacts)
  return &_impl_.contacts_;
}
inline const ::s_contact::PeopleInfo& Contacts::_internal_contacts(int index) const {
  return _impl_.contacts_.Get(index);
}
inline const ::s_contact::PeopleInfo& Contacts::contacts(int index) const {
  // @@protoc_insertion_point(field_get:s_contact.Contacts.contacts)
  return _internal_contacts(index);
}
inline ::s_contact::PeopleInfo* Contacts::_internal_add_contacts() {
  return _impl_.contacts_.Add();
}
inline ::s_contact::PeopleInfo* Contacts::add_contacts() {
  ::s_contact::PeopleInfo* _add = _internal_add_contacts();
  // @@protoc_insertion_point(field_add:s_contact.Contacts.contacts)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contact::PeopleInfo >&
Contacts::contacts() const {
  // @@protoc_insertion_point(field_list:s_contact.Contacts.contacts)
  return _impl_.contacts_;
}
...
template <> struct is_proto_enum< ::s_contact::PeopleInfo_phone_Type> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::s_contact::PeopleInfo_phone_Type>() {
  return ::s_contact::PeopleInfo_phone_Type_descriptor();
}
