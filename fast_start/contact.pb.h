...
// string email = 2;
inline void PeopleInfo::clear_email() {
  _impl_.email_.ClearToEmpty();
}
inline const std::string& PeopleInfo::email() const {
  // @@protoc_insertion_point(field_get:contact.PeopleInfo.email)
  return _internal_email();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PeopleInfo::set_email(ArgT0&& arg0, ArgT... args) {
 
 _impl_.email_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contact.PeopleInfo.email)
}
inline std::string* PeopleInfo::mutable_email() {
  std::string* _s = _internal_mutable_email();
  // @@protoc_insertion_point(field_mutable:contact.PeopleInfo.email)
  return _s;
}
inline const std::string& PeopleInfo::_internal_email() const {
  return _impl_.email_.Get();
}
inline void PeopleInfo::_internal_set_email(const std::string& value) {
  
  _impl_.email_.Set(value, GetArenaForAllocation());
}
inline std::string* PeopleInfo::_internal_mutable_email() {
  
  return _impl_.email_.Mutable(GetArenaForAllocation());
}
inline std::string* PeopleInfo::release_email() {
  // @@protoc_insertion_point(field_release:contact.PeopleInfo.email)
  return _impl_.email_.Release();
}
inline void PeopleInfo::set_allocated_email(std::string* email) {
  if (email != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:contact.PeopleInfo.email)
}
...
inline const std::string& PeopleInfo::phone() const {
  // @@protoc_insertion_point(field_get:contact.PeopleInfo.phone)
  return _internal_phone();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PeopleInfo::set_phone(ArgT0&& arg0, ArgT... args) {
 
 _impl_.phone_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contact.PeopleInfo.phone)
}
inline std::string* PeopleInfo::mutable_phone() {
  std::string* _s = _internal_mutable_phone();
  // @@protoc_insertion_point(field_mutable:contact.PeopleInfo.phone)
  return _s;
}
inline const std::string& PeopleInfo::_internal_phone() const {
  return _impl_.phone_.Get();
}
inline void PeopleInfo::_internal_set_phone(const std::string& value) {
  
  _impl_.phone_.Set(value, GetArenaForAllocation());
}
inline std::string* PeopleInfo::_internal_mutable_phone() {
  
  return _impl_.phone_.Mutable(GetArenaForAllocation());
}
inline std::string* PeopleInfo::release_phone() {
  // @@protoc_insertion_point(field_release:contact.PeopleInfo.phone)
  return _impl_.phone_.Release();
}
inline void PeopleInfo::set_allocated_phone(std::string* phone) {
  if (phone != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:contact.PeopleInfo.phone)
}
